...
interface IPaymentMethodSelectionScreenProps {
  navigation: NavigationProp<any>;
}

const PaymentMethodSelectionScreen: React.FC<IPaymentMethodSelectionScreenProps> = (props) => {
  ...
  const gotoAddBankPaymentMethod = () => {
    props.navigation.navigate('ProfileScreen', { screen: 'AddPaymentBank' });
  };
