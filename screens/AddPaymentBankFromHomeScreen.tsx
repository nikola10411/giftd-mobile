...
interface IAddPaymentBankFromHomeScreenProps {
  navigation: NavigationProp<any>;
}

const AddPaymentBankFromHomeScreen: React.FC<IAddPaymentBankFromHomeScreenProps> = (props) => {
  const countryList = [
    'US',
    'AE',
    'AR',
...
export default AddPaymentBankFromHomeScreen;
