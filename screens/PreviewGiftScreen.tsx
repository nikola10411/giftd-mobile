...
import { addGift, selectPaymentMethod } from '../actions/giftAppAction';
...
const PreviewGiftScreen: React.FC<IPreviewGiftScreenProps> = (props) => {
    ...
    const gotoResumePaymentScreen = () => {
        if (giftInfo && giftInfo.gift_primary_font && giftInfo.gift_secondary_font && selectedPaymentMethod) {
            dispatch(addGift(
                2,
