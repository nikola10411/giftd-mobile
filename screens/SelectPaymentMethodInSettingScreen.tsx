...
interface ISelectPaymentMethodInSettingScreenProps {
  navigation: NavigationProp<any>;
}

const SelectPaymentMethodInSettingScreen: React.FC<ISelectPaymentMethodInSettingScreenProps> = (props) => {
  ...
  const sengotoPaymentMethodSettingdGift = () => {
      ...
      // props.navigation.navigate('ProfileScreen', { screen: 'PaymentMethodSelectionScreen' });
  };
      ...
      </View>
      {
        (paymentMethodList && paymentMethodList.length > 0) ? (
          <>
                ...
                <View style={styles.modalView}>
                    {
                        fontsLoaded && paymentMethodList && paymentMethodList.filter((paymentMethod) => paymentMethod.type == 'bank').map((paymentMethod, index) => {
                            return (
                                <Pressable style={styles.infoLinkContainer} key={index} onPress={() => selectPaymentMethodHandle(paymentMethod)}>
                                    <View style={styles.infoWrapper}>
                                        <Image
...
export default SelectPaymentMethodInSettingScreen;
