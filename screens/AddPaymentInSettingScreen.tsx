...
interface IAddPaymentInSettingScreenProps {
    navigation: NavigationProp<any>;
}

const AddPaymentInSettingScreen: React.FC<IAddPaymentInSettingScreenProps> = (props) => {
...
export default AddPaymentInSettingScreen;
