...
import { clearEventState, getAllEventList, getEventList, getFilteredEventList, setEventInfo } from '../actions/giftAppAction';
...
interface IEventListAllScreenProps {
    navigation: NavigationProp<any>;
}

const EventListAllScreen: React.FC<IEventListAllScreenProps> = (props) => {
    ...
    const { eventList, eventAllList } = useSelector((state: IRootState) => state.giftApp)
                ...
                eventAllList.length > 0 ? (
                    <View style={styles.mainContainer}>
                        ...
                        <ScrollView style={styles.eventsContainer}>
                            {
                                eventAllList.map((eventInfo, index) => {
                                    return (
...
export default EventListAllScreen;
