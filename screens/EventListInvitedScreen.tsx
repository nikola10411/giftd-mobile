...
import { clearEventState, getEventList, getFilteredEventList, getInvitedEventList, setEventInfo } from '../actions/giftAppAction';
...
interface IEventListInvitedScreenProps {
    navigation: NavigationProp<any>;
}

const EventListInvitedScreen: React.FC<IEventListInvitedScreenProps> = (props) => {
    ...
    const gotoEventMyScreen = () => {
        props.navigation.navigate('EventListMy');
    };
    ...
    const { eventList, eventInvitedList } = useSelector((state: IRootState) => state.giftApp)
                ...
                eventInvitedList.length > 0 ? (
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.tabContainer}>
                            ...
                            <Pressable style={styles.tabButton} onPress={gotoEventMyScreen}>
                        ...
                        <ScrollView style={styles.eventsContainer}>
                            {
                                eventInvitedList.map((eventInfo, index) => {
                                    return (
                        ...
                        <View style={styles.blankWrapper}>
                            <View style={styles.blankContainer}>
                                ...
                                <Text style={[styles.blankText, {fontFamily: 'Work-Sans'}]}>
                                    You have not been invited to any events yet. All your future event invitations will show here.
                                </Text>
                            </View>
                        </View>
                    </View>
...
export default EventListInvitedScreen;
