...
interface ISelectPaymentMethodFromHomeScreenProps {
  navigation: NavigationProp<any>;
}

const SelectPaymentMethodFromHomeScreen: React.FC<ISelectPaymentMethodFromHomeScreenProps> = (props) => {
...
export default SelectPaymentMethodFromHomeScreen;
