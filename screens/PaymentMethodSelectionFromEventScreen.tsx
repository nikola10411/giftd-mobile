...
interface IPaymentMethodSelectionFromEventScreenProps {
  navigation: NavigationProp<any>;
}

const PaymentMethodSelectionFromEventScreen: React.FC<IPaymentMethodSelectionFromEventScreenProps> = (props) => {
  ...
  const gotoAddCardPaymentMethod = () => {
    props.navigation.navigate('ProfileScreen', { screen: 'AddPaymentFromEvent' });
  };

  const gotoAddBankPaymentMethod = () => {
    props.navigation.navigate('ProfileScreen', { screen: 'AddPaymentBankFromEvent' });
  };
...
export default PaymentMethodSelectionFromEventScreen;
