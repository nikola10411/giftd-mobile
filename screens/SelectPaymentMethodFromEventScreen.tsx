...
import { addThankyou, clearContactState, clearPaymentMethodState, clearThanksNoteState, getContactList, getFavoriteContactList, getFilteredContactList, getPaymentMethods, selectPaymentMethod, setContactInfo } from '../actions/giftAppAction';
...
interface ISelectPaymentMethodFromEventScreenProps {
  navigation: NavigationProp<any>;
}

const SelectPaymentMethodFromEventScreen: React.FC<ISelectPaymentMethodFromEventScreenProps> = (props) => {
  ...
  const { paymentMethodList, eventInfo, selectedPaymentMethod, isAddThankyouSuccess } = useSelector((state: IRootState) => state.giftApp);
  ...
  const selectPaymentMethodHandle = (paymentMethod: PaymentMethod) => {
    ...
    if (eventInfo && paymentMethod) {
        console.log(paymentMethod.stripe_token_id);
        dispatch(addThankyou(
            eventInfo.id,
  ...
  const sengotoPaymentMethodSettingdGift = () => {
      props.navigation.navigate('PaymentMethodSelectionFromEventScreen');
  };
...
export default SelectPaymentMethodFromEventScreen;
