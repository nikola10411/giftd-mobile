...
interface IAddPaymentBankFromEventScreenProps {
  navigation: NavigationProp<any>;
}

const AddPaymentBankFromEventScreen: React.FC<IAddPaymentBankFromEventScreenProps> = (props) => {
  const countryList = [
    'US',
    'AE',
    'AR',
      ...
      >
        <View style={styles.AboveWrapper}>
          <View style={styles.headerWrapper}>
            ...
            <View style={styles.textLinkWrapper}></View>
          </View>
        </View>
...
export default AddPaymentBankFromEventScreen;
