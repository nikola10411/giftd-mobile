...
import { addThankyou, getContactList,  getFilteredContactList, setMembersThankyou, setThankyouMembersInfo } from '../actions/giftAppAction';
import { IRootState } from '../reducers';
import CheckBox from 'react-native-check-box'
import Icon2 from 'react-native-vector-icons/EvilIcons';
import { useFonts } from 'expo-font';

interface ISelectContactsScreenProps {
    navigation: NavigationProp<any>;
}

const SelectContactsScreen: React.FC<ISelectContactsScreenProps> = (props) => {
    const dispatch = useDispatch();

    const { thanksNoteInfo, latestThankyou, isSetThankyouMemberSuccess } = useSelector((state: IRootState) => state.giftApp)
    ...
    useEffect(() => {
        if (isSetThankyouMemberSuccess) {
            props.navigation.navigate('ThanksResumePaymentScreen');
        }
    }, [isSetThankyouMemberSuccess])
