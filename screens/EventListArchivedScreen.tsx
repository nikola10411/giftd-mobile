...
interface IEventListArchivedScreenProps {
    navigation: NavigationProp<any>;
}

const EventListArchivedScreen: React.FC<IEventListArchivedScreenProps> = (props) => {
...
export default EventListArchivedScreen;
