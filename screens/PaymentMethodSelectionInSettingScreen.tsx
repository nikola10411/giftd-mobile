...
interface IPaymentMethodSelectionInSettingScreenProps {
  navigation: NavigationProp<any>;
}

const PaymentMethodSelectionInSettingScreen: React.FC<IPaymentMethodSelectionInSettingScreenProps> = (props) => {
  ...
  const gotoAddCardPaymentMethod = () => {
    props.navigation.navigate('AddPaymentInSetting');
  };

  const gotoAddBankPaymentMethod = () => {
    props.navigation.navigate('AddPaymentBankInSetting');
  };
...
export default PaymentMethodSelectionInSettingScreen;
